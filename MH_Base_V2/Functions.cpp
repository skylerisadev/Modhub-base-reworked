...
namespace Atomic
{
	...
	*/
	...
	void notify_Custom(const char* Head_txt, const char* fmt, ...)
	{
		...
		GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT(/*ytd file name "DO NOT USE .ytd"*/"Atomic", false);
		while (!GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED(/*ytd file name "DO NOT USE .ytd"*/"Atomic")) WAIT(0);

		UI::BEGIN_TEXT_COMMAND_THEFEED_POST("STRING");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(fmt);
		UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(/*ytd file name "DO NOT USE .ytd"*/"Atomic", /*Texture name inside ytd file*/"Icon", false, 1, "Atomic", Head_txt, 1, "", 9, 0); //  can create a custom ytd icon
